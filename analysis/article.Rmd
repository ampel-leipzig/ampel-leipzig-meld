...
```{r flowchart, results = "asis", echo = FALSE, fig.width = 4.5, fig.height = 2, fig.cap = "Flowchart Inclusion/Exclusion."}
library("consort")
library("grid")
...
analysed_records <- paste0("Analysed records (n = ", n_analysed, ")")
...
The data was analyzed and processed by SG.
