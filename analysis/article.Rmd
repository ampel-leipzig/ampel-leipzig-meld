...
abstract: >
  ...
  **Conclusion**:
      ...
      could improve the classical MELD score for 90-day survival prediction.
...
MELD 3.0 was calculated as described in kim2022:
...
MELD3 = 1.33 (if female) &+
        ...
        9.09 &* \ln(INR) + \\
        11.14 &* \ln(creatinine [mg/dL]) + 1.85 * (3.5 - albumin [g/dL]) - 1.83 * (3.5 - albumin [g/dL]) * \ln(creatinine [mg/dL]) + 6
\end{aligned}
$$
In contrast to MELD-Na the maximum allowed creatinine was 3.0 mg/dL.
...
could improve the prediction over previous published
MELD scores.
