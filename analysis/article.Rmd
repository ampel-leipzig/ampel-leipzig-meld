...
```{r flowchart, results = "asis", echo = FALSE, fig.width = 4.5, fig.height = 2, fig.cap = "Flowchart. Inclusion and exclusion of records."}
library("consort")
library("grid")
