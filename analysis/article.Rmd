...
All statistical and machine learning analyses were performed using R version
...
highest median concordance index [@harrell1982].
...
respectively.
As depicted in Figure \@ref(fig:observed-vs-meld-mortality-plot) and Table
\@ref(tab:tbl-observed-vs-expected-mortality) our observed 90 day mortality was
