...
```{r benchmark-plot, fig.cap = "Benchmark results of machine learning algorithms.", echo = FALSE, fig.width = 18, fig.height = 12, dev = c("png", "pdf")}
...
```{r roc-plot, echo = FALSE, fig.width = 18, fig.height = 12, dev = c("png", "pdf")}
...
```{r vimpbs, fig.width = 8, fig.height = 10, fig.cap = "Variable importance by frequency of bootstrap selections.", dev = c("png", "pdf"), echo = FALSE, message = FALSE}
tar_load(bootrcv)
plot(bootrcv, what = "selected", cex = 0.5)
```

```{r vimprf, fig.width = 8, fig.height = 10, fig.cap = "Variable importance by logrank in random forest.", dev = c("png", "pdf"), echo = FALSE, message = FALSE}
tar_load(rngr)
plot_dots(
